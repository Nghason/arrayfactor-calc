...
% mod_names = {'cds_lp'};
% mod_names = {'sincronia'};
% mod_names = {'dcoflow_min_all'};
% mod_names = {'dcoflow_min_negative';'dcoflow_mh';'dcoflow_br'};
% Viet: Thêm mode_names của bộ data, mod_names test riêng cds_cct
% mod_names = {'sincronia'; 'cds_lp'; 'cs_mha'; 'varys'; 'cds_cct'};
% mod_names = {'sincronia'; 'varys'; 'cds_cct'};
% mod_names = {'cds_cct';'cds_lp';'cs_mha';'sincronia';'dcoflow_min_all';};
mod_names = {'cds_cct'; 'cds_cct_SM'};
% mod_names = {'cds_cct'};
...
% Fix
params.csv_out = strcat(params.base_path, '+utils/fb_extract.csv');
inputs.fb_raw = strcat(params.base_path, '+utils/fb_coflows_raw.mat'); 
...
n_iters     = 10;          % nb of iterations
n_machines  = 4;            % nb of machines
n_coflows   = 6;           % nb of coflows
...
for mm = 1:length(mod_names)
    ...
    switch mod_name
        ...
        case {'sincronia','cs_mha','cs_dp','lpovls'}
            ...
            inputs.mod_option.(mod_name).runAllocation = true;
        % Viet: chỉnh thêm cds_cct
        case {'varys','CdsOptim','CdsRelax','w_CdsOptim','w_CdsRelax','cds_cct','cds_lp','cds_cct_SM'} 
