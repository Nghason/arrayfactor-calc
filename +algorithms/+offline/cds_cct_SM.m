...
% load"data_m4_c6";
%%
function outputs = cds_cct_SM(fabric,coflows)
...
Zn = Zn';
    ...
    outputs.cct = cct_avgsm(:, 1:n_coflows);
    outputs.ccts = cct_avgsm(2,find(cct_avgsm(2, 1:n_coflows) > 0));
    outputs.avg_cct = cct_avgsm(2, n_coflows+1);
